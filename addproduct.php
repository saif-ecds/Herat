...
$quantity = $_REQUEST['quantity0'].','.$_REQUEST['quantity1'].','.$_REQUEST['quantity2'].','.$_REQUEST['quantity3'].','.$_REQUEST['quantity4'].','.$_REQUEST['quantity5'].','.$_REQUEST['quantity6'].','.$_REQUEST['quantity7'].','.$_REQUEST['quantity8'];
//die();
